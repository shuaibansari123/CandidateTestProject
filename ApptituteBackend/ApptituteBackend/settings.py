"""
Django settings for ApptituteBackend project.
...
SECRET_KEY = 'django-insecure-dy#rp(hm@4#1^#o_yfm5dit1ntkk@6pnb(naq(m61)ug_a1cbj'
...
ROOT_URLCONF = 'ApptituteBackend.urls'
...
WSGI_APPLICATION = 'ApptituteBackend.wsgi.application'
